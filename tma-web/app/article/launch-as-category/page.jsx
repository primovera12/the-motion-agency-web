...
export const metadata = {
  title: "How to turn a product launch into a category-defining moment",
  description:
    "Most product launches add a feature. The best ones reframe an industry. Here's the playbook we use to turn a stage, a film and a 30-minute keynote into the load-bearing moment of a category.",
};

export default function ArticleLaunch() {
  return (
    <>
      ...
      <div className="case-page">
        ...
        <ArticleHero
          ...
          date="Feb 2026"
          readTime="6 min"
          title={<>How to turn a product launch into a <span className="ital">category-defining</span> moment.</>}
          deck="Most product launches add a feature. The best ones reframe an industry. Here's the playbook we use to turn a stage, a film and a 30-minute keynote into the load-bearing moment of a category."
        />
        ...
        <ArticleBody>
          ...
          <h2>1. Start with the argument, not the agenda.</h2>
          <p>
          ...
          <p>
            Reverse the order. Begin with one sentence: <em>after this event, the market should believe X.</em> Every minute of the run-of-show, every shot of the keynote film, every word of the founder's script must earn its place by serving that sentence. If a segment doesn't advance the argument, it's not a segment — it's filler.
          </p>

          <ArticleCallout kicker="The test">
            Write the sentence the market will say <span className="ital">about you</span> the morning after the launch.
            If your run-of-show doesn't make that sentence <span className="ital">unavoidable,</span> the run-of-show is wrong.
          </ArticleCallout>

          <h2>2. Build the film before you build the stage.</h2>
          <p>
          ...
          <p>When the room reads as a continuation of the screen, the audience stops watching a presentation and starts watching a story they're inside.</p>

          <h2>3. The 30-minute reveal beats the 90-minute keynote.</h2>
          <p>
          ...
          <ArticleStats
            items={[
              { v: "30 min", l: "Core keynote length" },
              { v: "3", l: "Max product unveils" },
              { v: "1", l: "Sentence the market repeats" },
            ]}
          />

          <h2>4. Design the room to do half the work.</h2>
          <p>
          ...
          <blockquote>
            ...
            <footer>— field note, TMA experience</footer>
          </blockquote>

          <h2>5. Plan the next 90 days before the doors open.</h2>
          <p>
          ...
          <p>
            Before the launch ships, the post-launch plan should already be written: which press, which partner activations, which sales-enablement assets, which social cuts, which founder-led LinkedIn arc. Filming and editing decisions made <em>during</em> the keynote should already have downstream cuts in mind — the social hero, the LinkedIn rip, the regional press cut, the merchant testimonial reel.
          </p>
          <p>A flagship moment that ends when the room empties has done its job for the audience in the room. A flagship moment built for the ninety days after has done its job for the business.</p>

          <h2>What separates a launch from a category moment.</h2>
          <p>
          ...
          <ul>
            <li>One argument, not five.</li>
            <li>One film, designed before the stage.</li>
            <li>Thirty minutes, not ninety.</li>
            <li>A room that does half the convincing on its own.</li>
            <li>A 90-day plan that turns the moment into pipeline.</li>
          </ul>
          <p>Build a launch around those five constraints and the production value follows naturally. Build it around production value alone and you'll have the most beautiful event nobody quotes.</p>

          <ArticleSignoff>
            <p>This piece is part of TMA's ongoing field notes on event design and category-defining launches across the GCC.</p>
            <p>
              See how this played out in practice — read our case study on <Link href="/case/foodics-boundless">Foodics — Boundless</Link>, or <Link href="/#contact">tell us what you're launching.</Link>
            </p>
          </ArticleSignoff>
        </ArticleBody>
