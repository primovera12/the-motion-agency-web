...
export const metadata = {
  ...
  description:
    "Two flagship product events that turned the stage into a launchpad. We unveiled Foodics Pay, Capital, and the Marketplace and reframed Foodics from POS provider to growth engine of F&B.",
};

export default function CaseFoodicsBoundless() {
  return (
    <>
