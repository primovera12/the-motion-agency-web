...
export const metadata = {
  title: "Zid — Ripple 2024",
  description:
    "A flagship moment in Diriyah for 1,000+ merchants. We unveiled Zid's unified Total Commerce platform — e-commerce, social, in-store, and cross-border.",
};

export default function CaseZidRipple() {
  return (
    <>
