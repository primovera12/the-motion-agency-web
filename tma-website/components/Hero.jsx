      ...
      <div className="container">
        <div className="hero-meta">
          <div className="hero-meta-block">
            <span>EST.</span><span className="v">2019</span>
          </div>
          <div className="hero-meta-block">
            <span>AMMAN</span><span className="v">·</span><span>RIYADH</span>
          </div>
          <div className="hero-meta-block">
            <span>SHOWREEL</span><span className="v">2025</span>
          </div>
        </div>

        <h1 className="hero-title">
          <span className="word w1"><span>WHERE</span></span>{" "}
          <span className="word w2"><span>STRATEGY</span></span><br />
          <span className="word w3"><span className="ital">MEETS</span></span>{" "}
          <span className="word w4"><span>BOLD</span></span><br />
